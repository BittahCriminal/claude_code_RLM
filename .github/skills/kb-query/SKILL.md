...
python3 knowledge/query.py combine <agent> .github/rlm_state/context.txt

# Initialize RLM with combined context
python3 .github/skills/rlm/scripts/rlm_repl.py init .github/rlm_state/context.txt
...
python3 knowledge/query.py combine kratix .github/rlm_state/kratix_context.txt
```
