GCR is using the newest Azure update manager for its patching service offering. In this page we briefly explain how the Azure update manager works and what are the benefit of using it.
