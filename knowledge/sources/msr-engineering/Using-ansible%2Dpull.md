# Introduction
ansible-pull is designed to pull from a git repo, and then run the playbooks you want from there. It's meant to be run from cron, so you can run this similar to a Chef agent.

Below are some references:
https://www.reddit.com/r/devops/comments/6fajam/ansible_in_pull_mode/<br>

# Sample script using GitHub
```bash
#!/bin/bash
